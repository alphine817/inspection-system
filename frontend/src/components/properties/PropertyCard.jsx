import { Bath, BedDouble, Building2, MapPin, Plus, Ruler } from 'lucide-react'
...
export default function PropertyCard({ property, units, onAddUnit }) {
  return (
      ...
      <div className="border-b border-slate-100 p-5 dark:border-slate-800/60">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <span className="rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-700 ring-1 ring-slate-200 dark:bg-slate-800/60 dark:text-slate-300 dark:ring-slate-700/40">
            ...
            {onAddUnit && (
              <button
                ...
                className="inline-flex items-center gap-1 rounded-full bg-brand-50 px-2.5 py-1 text-xs font-semibold text-brand-700 ring-1 ring-brand-100 transition-colors hover:bg-brand-100 dark:bg-brand-950/50 dark:text-brand-400 dark:ring-brand-900/60 dark:hover:bg-brand-950/80"
              >
      ...
      <div className="flex-1 p-5">
        {units.length ? (
          ...
          <button
            type="button"
            onClick={() => onAddUnit(property)}
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-slate-50 px-3 py-4 text-sm font-semibold text-brand-700 ring-1 ring-slate-100 transition-colors hover:bg-brand-50 hover:ring-brand-100 dark:bg-slate-950/40 dark:text-brand-400 dark:ring-slate-700/40 dark:hover:bg-brand-950/30 dark:hover:ring-brand-900/60"
          >
