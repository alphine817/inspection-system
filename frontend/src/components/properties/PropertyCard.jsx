...
function UnitRow({ unit }) {
  ...
  return (
    <li className="flex items-center justify-between gap-3 rounded-lg bg-white px-3 py-2.5 ring-1 ring-slate-100">
      <div className="min-w-0">
        <p className="truncate text-sm font-semibold text-slate-900">Unit {unit.unit_number}</p>
...
export default function PropertyCard({ property, units }) {
  return (
    <article className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-200 hover:border-brand-200 hover:shadow-md">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              <h3 className="truncate text-base font-bold text-slate-900">{property.name}</h3>
            </div>
      ...
      <div className="flex-1 p-5">
        {units.length ? (
          ...
          <p className="rounded-lg bg-slate-50 px-3 py-4 text-center text-sm text-slate-500 ring-1 ring-slate-100">
