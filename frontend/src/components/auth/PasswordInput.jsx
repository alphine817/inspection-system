  ...
  return (
    <div className={containerClassName}>
      ...
      <div className="relative">
        ...
        <button
          type="button"
          className="absolute top-1/2 right-2 inline-flex -translate-y-1/2 touch-manipulation rounded-lg p-2.5 text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-700 focus-visible:ring-brand-500 active:bg-slate-200"
