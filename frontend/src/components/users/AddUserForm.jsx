...
export default function AddUserForm({ id = 'add-user-form', onSubmitted }) {
  ...
  return (
    ...
    >
      <div className="mb-5">
        <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">Add User</h2>
        <p className="text-sm text-slate-500 dark:text-slate-400">Create a new team member with role-based access</p>
      </div>
